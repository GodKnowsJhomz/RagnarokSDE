...
namespace SDE.Editor.Generic.Lists
{
    ...
    public sealed class ClientItemAttributes : DbAttribute
    {
        ...
        public static readonly DbAttribute EffectID = new ClientItemAttributes(new DbAttribute("EffectID", typeof(string), "", "Effect ID"));
        public static readonly DbAttribute PackageID = new ClientItemAttributes(new DbAttribute("PackageID", typeof(string), "", "Package ID"));
