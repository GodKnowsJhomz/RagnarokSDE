...
namespace SDE.Editor.Generic.Lists
{
    public sealed class ServerDbs
    {
        ...
        public static readonly ServerDbs Homuns2 = new ServerDbs("homunculus_db2") { DisplayName = "Homuns2", SupportedFileType = FileType.Txt | FileType.Yaml, UseSubPath = false, AlternativeName = "import\\homunculus_db", IsImport = true };
        public static readonly ServerDbs Homuns = new ServerDbs("homunculus_db") { DisplayName = "Homuns", SupportedFileType = FileType.Txt | FileType.Yaml, AdditionalTable = Homuns2, UseSubPath = false };
        ...
        public static readonly ServerDbs Combos2 = new ServerDbs("import\\item_combo_db") { DisplayName = "Item Combo", SupportedFileType = FileType.Txt | FileType.Yaml, AlternativeName = "import\\item_combos", IsImport = true };
        public static readonly ServerDbs Combos = new ServerDbs("item_combo_db") { DisplayName = "Item Combo", AdditionalTable = Combos2, SupportedFileType = FileType.Txt | FileType.Yaml, AlternativeName = "item_combos" };
