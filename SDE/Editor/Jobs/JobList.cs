...
namespace SDE.Editor.Jobs
{
    public class JobList
    {
        ...
        // Dorams
        public static Job Summoner = new Job(1 << 13, 1 << 0, new string[] { "Doram race"}, null, @"°áÈ¥_¿©");
        public static Job BabySummoner = new Job(1 << 13, 1 << 2, new string[] { "Baby Doram race" }, null, "¹Ùµå:¹«Èñ");
        public static Job SpiritHandler = new Job(1 << 28, 1 << 0, new string[] { "Spirit Handler", "Spirit_Handler" });
        ...
        //  Special classes
        //__________________________________________
        public static Job AllClasses = new Job(-1, 127, new string[] { "Every Job", null });
        ...
        public static Job EveryJobExceptNoviceOld = new Job(ArcherClass.Id | SwordmanClass.Id | MageClass.Id | AcolyteClass.Id | MerchantClass.Id | ThiefClass.Id | TaekwonClass.Id | Gunslinger.Id | Ninja.Id | Rebellion.Id | KagerouOboro.Id | Summoner.Id | SpiritHandler.Id, 63, new string[] { "Every Job except Novice", null });
        public static Job EveryJobOld = new Job(ArcherClass.Id | SwordmanClass.Id | MageClass.Id | AcolyteClass.Id | MerchantClass.Id | ThiefClass.Id | TaekwonClass.Id | Gunslinger.Id | Ninja.Id | Novice.Id | Rebellion.Id | KagerouOboro.Id | Summoner.Id | SpiritHandler.Id, 63, new string[] { "Every Job", null });

        public static Job EveryJobExceptNovice = new Job(ArcherClass.Id | SwordmanClass.Id | MageClass.Id | AcolyteClass.Id | MerchantClass.Id | ThiefClass.Id | TaekwonClass.Id | GunslingerClass.Id | NinjaClass.Id | Rebellion.Id | KagerouOboro.Id | Summoner.Id | SpiritHandler.Id , 63, new string[] { "Every Job except Novice", null });
        public static Job EveryJob = new Job(ArcherClass.Id | SwordmanClass.Id | MageClass.Id | AcolyteClass.Id | MerchantClass.Id | ThiefClass.Id | TaekwonClass.Id | GunslingerClass.Id | NinjaClass.Id | Novice.Id | Rebellion.Id | KagerouOboro.Id | Summoner.Id | SpiritHandler.Id , 63, new string[] { "Every Job", null });
        ...
        private static string _generate(string output, long hexValue, JobGroup group, int gender, int equipLevel)
        {
            ...
            output = _checkFor(output, hexValue, SpiritHandler, group, equipLevel);
            return output;
        }
        ...
        public static List<Job> GetApplicableJobs(string value)
        {
            ...
            foreach (string stringJob in stringJobs)
            {
                ...
                {
                    jobs.AddRange(_getAllChildrenJobs("Novice").Concat(new Job[] { GetJob("Novice"), GetJob("Doram race"), GetJob("Spirit Handler") }));
                    previousJob = null;
                }
                //else if (
